...
<div class="inner-page">
  	<div class="container">
		<h3>Hướng dẫn đăng nhập nhà tuyển dụng</h3>
		<p>Đăng nhập ngay tài khoản Nhà tuyển dụng trên website Timviecnhanh.xyz bằng vài thao tác đơn giản dưới đây:</p>
		<p>Bước 1: Bấm vào nút "Đăng nhập" ở góc phải màn hình trang chủ hoặc <a href="{{ route('login.employer') }}">bấm vào đây »</a></p>
		<img src="{{ asset('images/huongdan/tut4.png') }}" width="800px" alt="placeholder+image">
		<p>Bước 2: Khi màn hình đăng nhập hiện ra, bạn bấm vào nút "Đăng nhập Nhà tuyển dụng"</p>
		<img src="{{ asset('images/huongdan/tut10.png') }}" width="800px" alt="placeholder+image">
