...
<div class="inner-page">
  	<div class="container">
		<h3>Hướng dẫn tạo tài khoản người tìm việc</h3>
		<p>Việc đăng ký tài khoản Người tìm việc trên Timviecnhanh.xyz rất đơn giản. Bạn chỉ mất 1 phút để thực hiện các bước sau đây:</p>
		<p>Bước 1: Tại trang chủ, bấm vào nút "Đăng ký" ở góc phải màn hình giao diện hoặc <a href="{{ route('register.user') }}">bấm vào đây »</a></p>
		<img src="{{ asset('images/huongdan/tut1.png') }}" width="800px" alt="placeholder+image">
		<p>Bước 2: Chọn "Đăng ký người tìm việc"</p>
		<img src="{{ asset('images/huongdan/tut2.png') }}" width="800px" alt="placeholder+image">
		<p>Bước 3: Điền đầy đủ thông tin yêu cầu. Sau đó, bấm vào nút "Đăng ký"</p>
		<img src="{{ asset('images/huongdan/tut3.png') }}" width="500px" alt="placeholder+image">
