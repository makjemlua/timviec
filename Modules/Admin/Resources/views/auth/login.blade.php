<link rel="stylesheet" type="text/css" href="{{ asset('theme_admin/css/login.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('theme_admin/css/login1.scss.css') }}">
...
<form action="" method="POST">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="email" name="email" id="loginEmail" maxlength="254" required />
	...
	<div class="inputGroup inputGroup3">
		...
		@if(Session::has('error'))
	        <div class="alert alert-danger alert-dismissible" style="position: fixed;z-index: 99">
...
<script type="text/javascript" src="{{ asset('theme_admin/js/login.js') }}"></script>